...
import { DEMO_HOTEL_CLASSIC } from "@/lib/mewsDemo";
...
export default function MarbrookHousePage() {
  ...
  async function provisionBooking() {
    ...
    const merchant = await devLogin(DEMO_HOTEL_CLASSIC.email);
    await updateMerchant({
      businessName: DEMO_HOTEL_CLASSIC.businessName,
      businessType: DEMO_HOTEL_CLASSIC.businessType,
      addressLine1: DEMO_HOTEL_CLASSIC.addressLine1,
      addressCity: DEMO_HOTEL_CLASSIC.addressCity,
      addressState: DEMO_HOTEL_CLASSIC.addressState,
      addressZip: DEMO_HOTEL_CLASSIC.addressZip,
    });
