...
//
// It owns the section's Panel as well as its contents. The editor itself opens
// in a modal (see UpdateCardSection), so this panel stays put underneath showing
// the current card while the guest edits.
